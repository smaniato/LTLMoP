...
This class performs all of the dipolar related 
calculations from the paper: Model Predictive 
Control for the Navigation of a Nonholonomic 
Vehicle with Field-of-View Constraints
"""
...
class DipolarController:
    ...
    def __init__(self, k1=.5, k2=1.5, k3=1, lambdaValue=3):
        """ A class that uses the dipolar controller from the paper
        
        :param k1: Linear velocity
        :param k2: Angular velocity gain
        :param k3: Slow down factor
    ...
    def getFieldAt(self, poseCurr, poseDes):
        ...
        :param poseCurr: The current pose
        :param poseDes: The desired pose
    ...
    def getControls(self, poseCurr, poseDes, posePrev, delT):
        """ Get the dipolar controls that will take the robot from poseCurr to
        poseDes.
        
        :param poseCurr: The current pose
        :param poseDes: The desired pose
        :param posePrev: The previous pose
