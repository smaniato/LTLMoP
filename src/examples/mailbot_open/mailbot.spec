...
# Letter recipients that the robot already knows about.
Group Letters is empty

# Regions that each letter needs to be delivered to.
...
If you are sensing any Letter then go to the corresponding Office
