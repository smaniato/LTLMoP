...
robot starts in r2 with resynthesize and not explore_room_done and not requestExplore and explore and needs_resynthesis
### assumptions ###
### main specification ###
#group patrol_locations is empty
group patrol_locations is r1,r2,r3
